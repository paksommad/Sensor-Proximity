package com.miftahul.proximity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void run() { // Function runs every MINUTES minutes.
                        ...
                        handler.post(
                                new Runnable()
                                {
                                    ...
                                    public void run()
                                    {
                                        Toast.makeText(SensorActivity.this, "Data berhasil ditambah", Toast.LENGTH_SHORT).show();
                                    }
                                }
                        );
                    }
        ...
        Tampil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SensorActivity.this, ListViewActivity.class);
